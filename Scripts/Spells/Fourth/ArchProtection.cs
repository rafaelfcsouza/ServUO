...
namespace Server.Spells.Fourth
{
    public class ArchProtectionSpell : MagerySpell
    {
        ...
        protected override Target CreateTarget() => new SpellTarget<ArchProtectionSpell, IPoint3D>(this, TargetFlags.Beneficial);
            ...
            else if (CheckSequence())
            {
                ...
                for (int i = 0; i < targets.Count; ++i)
                {
                    ...
                    if (m == Caster || (party != null && party.Contains(m)))
                    {
                        ...
                        Spells.Second.ProtectionSpell.StartProtection(Caster, m, true);
                    }
                }
            }
